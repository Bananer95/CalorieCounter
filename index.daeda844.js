...
})({"8PunM":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "b81f9df2daeda844";
...
},{}],"ceL7S":[function(require,module,exports) {
...
function eventBtn() {
    btnReult.addEventListener('click', (event)=>{
        ...
        if (_eventLinksJs.checkPoitn === 0) {
            if (btnRes) popatResult.classList.add('open');
            else if (btnCler) popatResult.classList.remove('open');
        } else {
            if (_closingEventsJs.age.classList.contains('show')) {
                if (btnCler) {
                    _closingEventsJs.age.classList.remove('show');
                    checkPoitn = 1;
                    checkBtn();
                }
            }
...
},{"./eventLinks.js":"9y8CE","./closingEvents.js":"cihMi","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9y8CE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _closingEventsJs = require("./closingEvents.js");
var _eventBtnJs = require("./eventBtn.js");
...
function eventLinks() {
    links.addEventListener('click', (event)=>{
        switch(event.target.dataset.action){
            case 'link_gender':
                _closingEventsJs.gender.classList.add('show');
                console.log(322);
                break;
            case 'link_fisical':
                _closingEventsJs.fisical.classList.add('show');
                break;
            case 'link_age':
                _closingEventsJs.age.classList.add('show');
                break;
            case 'link_groth':
                _closingEventsJs.groth.classList.add('show');
                break;
            case 'link_eight':
                _closingEventsJs.eight.classList.add('show');
                break;
        }
    });
    return;
...
},{"./closingEvents.js":"cihMi","./eventBtn.js":"fBXZA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cihMi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}]},["8PunM","ceL7S"], "ceL7S", "parcelRequire0145")

//# sourceMappingURL=index.daeda844.js.map
